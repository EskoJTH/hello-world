            ...
            while (on)
            {
                ...
                switch (tila)
                {
                            ...
                            case "JOIN":
                                switch (pelaajia)
                                {
                                    ...
                                    case 1:
                                        ...
                                        break;
                                    default:
                                        Console.WriteLine("Pelaajia Liikaa! En toimi.");
                                        break;
                                }
                        ...
                        if (palat[0].Equals("DATA") && remoteEP.Equals(asiakkaat[vuoro]))
                        {
                            try
                            {
                                if (luku == int.Parse(palat[1]))
                                {
                                    ...
                                    laheta(palvelin, asiakkaat[vastustaja(vuoro)], "QUIT", "502 " +palat[1]);
                                    tila = "END";
                                }
                                else
                                {
                            ...
                            {
                                Console.WriteLine("Epänumero löydetty! ... Ehkä!");
                    ...
                    case "WAIT_ACK":
                        ...
                        break;
                    case "END":
                        if (palat[0].Equals("ACK") && palat[1].Equals("500")) lopetusKUI++;
                        if(lopetusKUI == 2)
                        {
                            tila = "CLOSED";
                        }
